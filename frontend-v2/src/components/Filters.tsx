...
export function Filters({
   ...
   return (
      <span className="relative inline-flex items-center" ref={pop.rootRef}>
         <button
            ref={pop.triggerRef}
            type="button"
         ...
         {pop.open && (
            <span
               ...
               role="dialog"
               aria-label="Filters"
               className="popover absolute top-full left-0 z-50 mt-1 block max-h-[460px] w-[300px] overflow-auto rounded-lg border border-line bg-surface p-2 shadow-md outline-none"
            >
