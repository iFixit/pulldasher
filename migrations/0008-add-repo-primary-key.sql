...
ALTER TABLE comments ADD PRIMARY KEY (repo, number);
---
...
ALTER TABLE pull_labels ADD PRIMARY KEY (repo, number);
---
ALTER TABLE pull_signatures ADD PRIMARY KEY (repo, number);
---
