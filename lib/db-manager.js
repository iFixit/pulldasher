var _ = require('underscore'),
    ...
    DBHistoryLabel = require('../models/db_historylabel'),
...
var dbManager = module.exports = {
   ...
   insertLabelHistory: function(historylabel){
      debug("Calling insertHistoryLabel for label '%s' on pull #%s in repo %s",
       historylabel.data.title, historylabel.data.number, historylabel.data.repo);
      var dbHistoryLabel = new DBHistoryLabel(historylabel);
      return dbHistoryLabel.save();
   },
   ...
   updateLabelHistory: function updateLabelHistory(historylabel){
      debug("Calling updateLabelHistory for label '%s' on issue #%s",
       historylabel.data.title, historylabel.data.number);
      return (new DBHistoryLabel(historylabel)).update();
   },
