...
module.exports = {
    ...
    * signatures, and return a promise that resolve when both of those
   ...
   insertSignature: function(signature) {
      ...
      return invalidate.done(function() {
         dbSignature.save();
      });
   ...
   insertSignatures: function(signatures) {
      ...
      var signaturesAdded = signatures.reduce(function(signatureAdded, sig) {
         return signatureAdded.then(function() {
