var _ = require('underscore'),
    ...
    debug = require('debug')('db-manager'),
...
module.exports = {
   ...
   updateCommitStatus: function(updatedStatus) {
      debug('Calling `updateCommitStatus`...');
      var self = this;
      ...
      return new Promise(function(resolve, reject) {
         dbStatus.save().done(function() {
            number.done(function(n) {
               ...
               if (n === null) {
                  resolve();
                  debug('updateCommitStatus: commit no longer #%ss HEAD', number);
                  return;
               }
   ...
   invalidateSignatures: function(number, types) {
      debug('Calling invalidateSignatures...');
      var q_update = '\
   ...
   deleteSignatures: function(number) {
      debug('Calling deleteSignatures...');
      return new Promise(function(resolve, reject) {
