...
module.exports = {
   ...
   // Deployment config that used to live in the frontend's static config.json;
   // it now lives here (the one source) and is delivered to the board over the
   ...
   // or {} to fall back to the size heuristic.
   weightLabels: {
      'size: XS': 'XS',
      'size: S': 'S',
      'size: M': 'M',
